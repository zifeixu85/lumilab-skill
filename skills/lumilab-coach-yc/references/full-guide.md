...
```
Coach: 24 小时内，你能联系到 10 个这样的人吗？说出他们的名字或具体在哪。
...
```
Coach: Why now：5 年前为什么做不了？5 年后为什么晚了？
     （技术变了？平台变了？人群变了？政策变了？）
...
```
Lumi Lab Q1: 一句话，≤30 字。不准用"赋能 / 一站式 / 打造"。
用户: "用 AI 帮中小企业自动生成小红书爆款笔记"
Coach: 缩 → "帮线下美容店每周自动写 7 条小红书笔记"（更具体，把"中小企业"换成一类）
用户确认 → 落地

Lumi Lab Q2: 给谁？要能画出脸。
用户: "线下小店老板"
Coach: 太宽。火锅店？理发店？美甲店？三选一最先打的那个。
用户: "上海 / 杭州 / 成都的美甲店老板，30-40 岁女性，店面 2-4 个工位，月营业额 5-15 万"
Coach: 好。这是 ICP。

Lumi Lab Q3: 她们现在怎么做小红书？上一次发笔记是什么时候？
用户: "大部分自己拍自己写，断更率很高，问过 3 个老板都说'懒得想文案'"
Coach: 谁付过钱？付给谁？多少？
用户: "有 1 个老板每月 800 给同行学徒代写，但不满意"
Coach: 锚定。$800/月 = 现存替代品价格。

Lumi Lab Q4: 24h 内能联系到 10 个吗？
用户: "我自己开过美甲店，朋友圈有 30+ 老板"
Coach: founder-user fit + distribution。✓
...
Lumi Lab Q6: Why now：2024 年小红书算法重视图文 + LLM 文案质量过线。
...
由 Lumi Lab 在 7 天后主动 ping 用户复盘，不依赖 Studio 提醒。
